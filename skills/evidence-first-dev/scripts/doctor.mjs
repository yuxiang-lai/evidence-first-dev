...
const candidates = [
  ["Cursor skill", ".cursor/skills/evidence-first-dev/SKILL.md"],
  ["OpenCode skill", ".opencode/skills/evidence-first-dev/SKILL.md"],
  ["Agent-compatible skill", ".agents/skills/evidence-first-dev/SKILL.md"],
  ["Cursor compatibility rule", ".cursor/rules/evidence-first-dev.mdc"],
